  ...
  return (
    <div className="carousel-con">
      ...
      <Slider {...settings}>
        <div className="card">
          <img
            src="https://res.cloudinary.com/dly8bneey/image/upload/v1693720824/t3chvcuc1qxahwz7t3sl.png"
            alt="img-c"
            className="img-c"
          />
        ...
        <div className="card">
          <img
            src="https://res.cloudinary.com/dly8bneey/image/upload/v1693722764/mjpluqqnn1dstcs0dkxt.png"
            alt="img-c"
            className="img-c"
          />
        ...
        <div className="card">
          <img
            src="https://res.cloudinary.com/dly8bneey/image/upload/v1693722994/vydspz6s7onugpu7ihyh.png"
            alt="img-c"
            className="img-c"
          />
        ...
        <div className="card">
          <img
            src="https://res.cloudinary.com/dly8bneey/image/upload/v1693723148/xyzuoitrj9y21zxj0p5l.png"
            alt="img-c"
            className="img-c"
          />
          <h3 className="head-s">Harvard University</h3>
