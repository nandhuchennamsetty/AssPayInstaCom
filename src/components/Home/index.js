...
const Home = () => (
  <div className="home-container">
    ...
    <div className="fst-con">
      <div className="signup-con">
        <div className="sign-min">
          ...
          <h1 className="head-trop">
            Tropical
            <br /> Destinations
            <br />
            <span className="head-student">For Student</span>
          </h1>
      ...
      <div className="fst-img-con">
        <img
          src="https://res.cloudinary.com/dly8bneey/image/upload/v1693651827/hgla4md8drpgqdk1rzzp.png"
          alt="logo"
          className="boy-logo"
        />
      </div>
    ...
    <div className="fst-con">
      <div className="signup-con pg1">
        <div className="sign-min pg1-min">
          <div className="profile-con">
            <img
              src="https://res.cloudinary.com/dly8bneey/image/upload/v1693674453/smmqxijvv5s7fkwvoplr.png"
              className="img-g1"
              alt="img-g1"
            />
      ...
      <div className="fst-img-con pg2-ex-main">
        <div className="pag-2-explore-con">
          <h1 className="p2-head">
            Tropical Adventure
            <br />
            <span className="span-el">for Students.</span>
          </h1>
          <p className="para-tro">
    ...
    <div className="fst-con">
      ...
      <div className="fst-img-con">
        <img
          src="https://res.cloudinary.com/dly8bneey/image/upload/v1693733445/rksllf9d5tns7yi5qwdq.png"
          alt="logo"
          className="boy-logo"
        />
      </div>
    ...
    <div className="fst-con">
      <div className="fst-img-con">
        <img
          src="https://res.cloudinary.com/dly8bneey/image/upload/v1693733994/oixygl8i2rkryvhjzd6q.png"
          alt="logo"
          className="boy-logo"
        />
      </div>
    ...
    <div className="profile-conp">
      ...
      <div className="mini-3con">
        <div className="prof-3con">
          <img
            src="https://res.cloudinary.com/dly8bneey/image/upload/v1693739203/mr2wwc3tvy18zsnvgq4p.png"
            alt="profile-1"
            className="profile-1"
          />
          <h1 className="profile-1-head">Corey Korsgaars</h1>
          <hr className="hr-line" />
          <p className="pa-profile">
        ...
        <div className="prof-3con">
          <img
            src="https://res.cloudinary.com/dly8bneey/image/upload/v1693742140/l0dho3j4hqaitztx4tqn.png"
            alt="profile-1"
            className="profile-1"
          />
          <h1 className="profile-1-head">Corey Korsgaars</h1>
        ...
        <div className="prof-3con">
          <img
            src="https://res.cloudinary.com/dly8bneey/image/upload/v1693742259/xpjfjwkfmscya5nfcei6.png"
            alt="profile-1"
            className="profile-1"
          />
          <h1 className="profile-1-head">Corey Korsgaars</h1>
